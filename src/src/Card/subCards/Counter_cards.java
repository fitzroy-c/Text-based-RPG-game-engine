...
public class Counter_cards extends Cards {
     ...
     * @param manaCost
     */
    public Counter_cards(int cardID, CardClass cardClass, Rarity rarity, String name, String description, String impactDescription, PlayerCareer career, int cardLevel, int maxCardLevel, int movementCost, int manaCost) {
