...
public class Mana_cards extends Cards {
     ...
     * @param manaCost
     */
    public Mana_cards(int cardID, CardClass cardClass, Rarity rarity, String name, String description, String impactDescription, String career, int cardLevel, int maxCardLevel, int movementCost, int manaCost) {
