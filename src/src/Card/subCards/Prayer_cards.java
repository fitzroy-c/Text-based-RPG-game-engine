...
public class Prayer_cards extends Cards {
     ...
     * @param manaCost
     */
    public Prayer_cards(int cardID, CardClass cardClass, Rarity rarity, String name, String description, String impactDescription, String career, int cardLevel, int maxCardLevel, int movementCost, int manaCost) {
